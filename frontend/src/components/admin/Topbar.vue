  ...
  <header class="flex items-center justify-between border-b border-gray-200 bg-white px-6 py-4">
    <div class="flex items-center gap-4">
      <input
        ...
        class="w-96 rounded-lg border border-gray-300 bg-gray-100 px-4 py-2 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
    </div>
    ...
    <div class="flex items-center gap-5">
      ...
      <div class="flex items-center gap-3 rounded-lg border border-gray-200 bg-gray-50 px-3 py-1.5">
        <img
        ...
        <div class="leading-tight">
          ...
          <p class="text-xs text-gray-500">{{ props.adminEmail || 'Administrator' }}</p>
        </div>
      </div>
    </div>
  </header>
